...
package net.mcreator.ourcraft_legacy.entity;
...
import net.mcreator.ourcraft_legacy.procedures.DarkKnightSkillsProcedure;
import net.mcreator.ourcraft_legacy.init.OurcraftLegacyModEntities;

public class DarkKnightEntity extends Monster {
	public DarkKnightEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(OurcraftLegacyModEntities.DARK_KNIGHT.get(), world);
	}
	...
	public DarkKnightEntity(EntityType<DarkKnightEntity> type, Level world) {
		...
		xpReward = 6;
		setNoAi(false);
		setCustomName(Component.literal("Dark Knight"));
		setCustomNameVisible(true);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.NETHERITE_SWORD));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(Blocks.POLISHED_BLACKSTONE));
	...
	public void baseTick() {
		super.baseTick();
		DarkKnightSkillsProcedure.execute(this);
	}

	public static void init() {
		SpawnPlacements.register(OurcraftLegacyModEntities.DARK_KNIGHT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
